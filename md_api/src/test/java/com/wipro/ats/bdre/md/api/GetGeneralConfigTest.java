...
public class GetGeneralConfigTest {
    private static final Logger LOGGER = Logger.getLogger(GetGeneralConfigTest.class);

    @Ignore
    @Test
    public void testByConigGroupOnly() throws Exception {
        GetGeneralConfig getGeneralConfig = new GetGeneralConfig();
        List<GeneralConfig> generalConfigList = getGeneralConfig.byConigGroupOnly("1", 1);
