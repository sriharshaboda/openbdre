...
CREATE TABLE PROCESS_TEMPLATE (
  ...
  CONSTRAINT PERMISSION_TYPE_ID4 FOREIGN KEY (USER_ACCESS_ID) REFERENCES PERMISSION_TYPE (PERMISSION_TYPE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT PERMISSION_TYPE_ID5 FOREIGN KEY (GROUP_ACCESS_ID) REFERENCES PERMISSION_TYPE (PERMISSION_TYPE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT PERMISSION_TYPE_ID6 FOREIGN KEY (OTHERS_ACCESS_ID) REFERENCES PERMISSION_TYPE (PERMISSION_TYPE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT OWNER_CHECK1 FOREIGN KEY(OWNER_ROLE_ID) REFERENCES USER_ROLES (USER_ROLE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE ANALYTICS_APPS (
 ...
 CREATE  TABLE MESSAGES (
   MESSAGENAME VARCHAR(45) NOT NULL ,
   FORMAT VARCHAR(45) NOT NULL ,
   MESSAGE_SCHEMA VARCHAR(2049) NOT NULL,
