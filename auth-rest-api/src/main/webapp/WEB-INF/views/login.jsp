...
<html>
	...
	<style>
	     body{background-image: url("../../css/images/WiProActive_BG.jpg");width: 100%;height: 100%;background-size: cover;overflow: hidden;}
	    ...
	    .text-info{color: #FFFFFF;font-size:40px;border-radius: 5px;padding-top: 2%;padding-bottom: 0%;}
	...
	<img id="logo" class="center-block img-responsive logo" src="../../css/images/Wipro_Logo.jpg"/>
